...
const TEMPLATES = [
  ...
  },
  {
    id: "5",
    name: "BLocks Design",
    description: "Minimalist academic cover featuring blue and orange blocks.",
  ...
  return (
    <div className="min-h-screen pb-1 bg-[#dbeafe]">
      <ToolHeader
        ...
        desc="Choose a template and generate a professional assignment cover page instantly. Fill in your details and download as PDF.s"
      />
